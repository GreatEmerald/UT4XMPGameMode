...
AXEctoCharacter::AXEctoCharacter(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer.SetDefaultSubobjectClass<UXEctoCharacterMovement>(ACharacter::CharacterMovementComponentName))
{
	HealthMax = 125;
	MaxStackedArmor = 150;
}
