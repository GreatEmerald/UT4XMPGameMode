...
AXEndoCharacter::AXEndoCharacter(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer.SetDefaultSubobjectClass<UXEndoCharacterMovement>(ACharacter::CharacterMovementComponentName))
{
	HealthMax = 175;
	MaxStackedArmor = 200;
}
