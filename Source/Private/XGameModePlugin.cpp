...
class FXGameModePlugin : public IModuleInterface
{
	virtual void StartupModule() override;
	virtual void ShutdownModule() override;
};

IMPLEMENT_MODULE( FXGameModePlugin, XGameMode )
void FXGameModePlugin::StartupModule(){}
void FXGameModePlugin::ShutdownModule(){}
